    ...
    public class MappingResolver : IMappingResolver
    {
            ...
            where TProfile : Profile
        {
            ...
            return new SuspensionSystem<TProfile>
            {
                ...
                SuspensionAArmLower = SuspensionAArm<TProfile>.Create(runAnalysisRequest.SuspensionAArmLower, calculateReactionsResponseData.AArmLowerReaction1.AbsolutValue, calculateReactionsResponseData.AArmLowerReaction2.AbsolutValue),
                SuspensionAArmUpper = SuspensionAArm<TProfile>.Create(runAnalysisRequest.SuspensionAArmUpper, calculateReactionsResponseData.AArmUpperReaction1.AbsolutValue, calculateReactionsResponseData.AArmUpperReaction2.AbsolutValue),
                TieRod = TieRod<TProfile>.Create(runAnalysisRequest.TieRod, calculateReactionsResponseData.TieRodReaction.AbsolutValue)
            };
        }
    }
}
